# src/train_hires_symbols_128.py
...
print("학습할 기호 (128x128):", class_names)
...
# 새 모델 파일 이름 사용
np.save('../models/hires_symbol_class_names_128.npy', class_names)
model.save('../models/hires_symbol_model_128.h5')
print("초고해상도 기호 전문가 모델이 저장되었습니다.")